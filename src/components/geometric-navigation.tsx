...
const GeometricNavigation = () => {
  ...
  return (
    <motion.nav
      ...
      className="fixed top-0 left-0 right-0 z-50 px-6 py-4 backdrop-blur-sm bg-[#030303]/80 border-b border-white/[0.08]"
    >
      <div className="max-w-7xl mx-auto flex items-center justify-between">
        ...
        >
          ...
          >
            ...
            />
            <motion.div
              className="absolute -bottom-1 -left-1 w-1.5 h-1.5 bg-rose-400/60 rounded-full"
            ...
            return (
              ...
              >
                <button
                  ...
                  className={cn(
                    "relative px-4 py-2 rounded-lg font-medium transition-all duration-300", // smaller padding
                    isActive
